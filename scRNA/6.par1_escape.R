...
my_comparisons <- list(c("TS2", "TS2F"), c("TS2", "TS2M"),
                      c("TS3", "TS3F"), c("TS3", "TS3M"))
...
ggsave("../../figs/fig2/IgD-/X_key_gene_exp.pdf", width = 5, height = 6)
...
ggsave("../../figs/fig2/naive/X_key_gene_exp.pdf", width = 5, height = 6)